...
- 本次审查同步：A02 只负责建筑布局与壁画位置认知。第五幅、第一幅、第二幅可作为当前项目编号使用；正式展陈称谓、墙位对应关系及第三幅、第四幅的展示范围仍待资料与原图核对。
- 用户提供的 A02 草稿截图另提出：中央水龙祠模型按第五幅 → 第一幅 → 第二幅亮起高亮路线，建立整体位置认知。该方案与 A03/A04 当前分工存在冲突，暂记为“草稿意图，待用户确认”，不得直接作为正式文案或实现边界。
...
- 本次审查同步：A03 负责主题入口与五铺关系，不重复 A04 的第五幅 → 第一幅 → 第二幅路线动画；“五铺”的具体空间关系仍需以可靠布局资料核对。
