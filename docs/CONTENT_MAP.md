...
- 展示内容：A04 完整路线总结后，使 `mural-05` 成为焦点；进入第五幅真实图像，展示整体构图、简短基本介绍、1—3 个经核实的视觉线索，再恢复完整画面。
- 图片：`水龙祠壁画素材/网页展示图/mural-05-display.webp`；细部按需使用 `水龙祠壁画素材/高清展示图/mural-05-detail.webp`。
- 可见线索：具体局部与裁切范围待逐项对照原图核验；本轮不指定人物身份、仪式或象征意义。
- 来源：现有第五铺项目素材及用户确认的章节目标；具体导读文字须补充可追溯的图像位置或文献页码。
- 核验状态：两种 WebP 文件在本地工作树存在，但未被 Git 追踪；远端可用性未验证。最终采用版本、可见线索、现场墙位待确认。文件存在不等于图像释读已证实。

### A06 第一幅壁画导读

- 展示内容：第五幅导读结束后短暂提示 ⑤→① 空间关系；聚焦 `mural-01`，进入第一幅真实图像，展示整体、简短基本介绍、1—3 个经核实的视觉线索，再恢复完整画面。
- 图片：`水龙祠壁画素材/网页展示图/mural-01-display.webp`；细部按需使用 `水龙祠壁画素材/高清展示图/mural-01-detail.webp`。
- 可见线索：具体局部与裁切范围待逐项对照原图核验；不以第一幅仅作路线过场。
- 来源：现有第一铺项目素材及用户确认的章节目标；具体释读须补充可靠资料。
- 核验状态：两种 WebP 文件在本地工作树存在，但未被 Git 追踪；远端可用性未验证。最终采用版本、可见线索、现场墙位待确认。

### A07 第二幅《入将图》导读

- 展示内容：第一幅导读结束后短暂提示 ①→②；进入第二幅《入将图》真实图像，稳定展示整体、基础介绍、2—3 个经核实的可见线索，再恢复整体。详细人物节点和自由探索归模块 B。
- 可见线索与研究释读候选（由原 A05 规划迁入，以下内容不等于已选定上屏文案）：
...
- 核验状态：用户已确认第二幅对应模块 B《入将图》；两种 WebP 文件在本地工作树存在，但未被 Git 追踪，远端可用性未验证。具体可见元素、裁切及论文解释须分层核验；人物身份、仪式和寓意不标为“已确认”。
